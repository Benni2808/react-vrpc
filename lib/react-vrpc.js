...
var VrpcBackendMaker = function (_Component) {
  ...
  (0, _createClass3.default)(VrpcBackendMaker, [{
                    ...
                    return _regenerator2.default.wrap(function _callee$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          ...
                          case 2:
                            keys = _this2.filterBackends(className, agent, backends);
      ...
      Object.keys(backends).forEach(function (key) {
        if (!backends[key].instance && !backends[key].args) {
          ...
          var backend = {
                  ...
                  while (1) {
                    switch (_context7.prev = _context7.next) {
                      case 0:
                        ...
                        return _context7.abrupt('return', vrpcManagedInstances.get(id).backend);

                      case 2:
                        _context7.next = 4;
                        return client.getInstance(id, { agent: agent });
                ...
                return _regenerator2.default.wrap(function _callee7$(_context8) {
                  while (1) {
                    switch (_context8.prev = _context8.next) {
                      case 0:
                        return _context8.abrupt('return', client.delete(id, { agent: agent }));
            ...
            callAll: function () {
              var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee8(functionName, _ref18) {
                ...
                return _regenerator2.default.wrap(function _callee8$(_context9) {
                  while (1) {
                    switch (_context9.prev = _context9.next) {
                      case 0:
                        return _context9.abrupt('return', client.callAll({
                          agent: agent,
              ...
              return function callAll(_x11, _x12) {
    ...
    key: 'filterBackends',
    value: function filterBackends(className, agent, backends) {
      var ret = [];
...
function useBackend(name, id) {
  var _useContext2 = (0, _react.useContext)(vrpcClientContext),
  ...
  (0, _react.useEffect)(function () {
    ...
    if (error) {
      return { backend: null, loading: false, error: error };
    }
    ...
    if (!vrpcManagedInstances.has(id)) {
      vrpcManagedInstances.set(id, { backend: null, loading: true, error: null });
      client.getInstance(id).then(function (proxy) {
        var managedInstance = {
          backend: proxy,
          loading: false,
          error: null
